...
| Plugin | What it does |
|--------|--------------|
| [`sdd-kit`](plugins/sdd-kit/AGENTS.md) | Spec-driven development kit: skill `spec-writer` (grills you into a complete, testable `spec.md`) plus future execution-plan skills. |
